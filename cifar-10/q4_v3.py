...
model.add(Flatten())
model.add(Dense(512, init='he_normal', W_regularizer=l2(0.03), b_regularizer=l2(0.03)))
model.add(Activation('relu'))
model.add(BatchNormalization())
...
pickle.dump( history.history, open( "q4_v3.p", "wb" ) )
