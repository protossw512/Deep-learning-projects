...
adam = keras.optimizers.Adam(lr=0.002, beta_1=0.9, beta_2=0.999, epsilon=1e-06, decay=0.0001)
...
pickle.dump( history.history, open( "q1_v4.p", "wb" ) )
