...
if not data_augmentation:
    ...
    history = model.fit_generator(datagen.flow(X_train, Y_train , batch_size=batch_size),
                        ...
                        nb_epoch=nb_epoch, show_accuracy=True,
                                  validation_data=datagen_test.flow(X_test, Y_test, batch_size=batch_size),nb_val_samples=X_test.shape[0], 
                                  nb_worker=1, callbacks=callbacks_list)
    model.save('q1_v3-4.h5')
print(history.history.keys())
# pickle.dump( history.history, open( "q1_v3-4.p", "wb" ) )
