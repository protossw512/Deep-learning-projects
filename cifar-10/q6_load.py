...
model = keras.models.load_model('q6.h5')
# let's train the model using SGD + momentum (how original).
sgd = SGD(lr=0.03, decay=0.03, momentum=0.7, nesterov=True)
adam = keras.optimizers.Adam(lr=0.001, beta_1=0.8, beta_2=0.9, epsilon=1e-06, decay=1e-3)
